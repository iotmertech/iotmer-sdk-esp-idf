...
- **High-level flow**: Wi‑Fi, HTTPS device provisioning, credentials in NVS, MQTT (TLS), optional HTTPS OTA.
...
| 4 | [`components/iotmer/Kconfig.projbuild`](components/iotmer/Kconfig.projbuild) | All `CONFIG_IOTMER_*` symbols |
